...
> Die Abo-Übersicht ist seit FE-FC-05 ([#338](https://github.com/dfme/budget-buddy/issues/338)) der Abschnitt «Erkannte Abos» auf der Seite «Ausgaben» (`/ausgaben`), keine eigene Seite mehr; `/abos` und `/fixkosten` (Name der Seite bis FE-FC-07, [#355](https://github.com/dfme/budget-buddy/issues/355)) leiten dorthin um. Erkannte, nicht verneinte Abos fliessen seither wie Fixkosten in den Safe-to-Spend ein, solange sie laufen ([US-06](US-06-safe-to-spend.md)).
>
> Seit BE-REC-04 ([#350](https://github.com/dfme/budget-buddy/issues/350)) bewertet jeder Import die erkannten Abos neu: der Betrag folgt der jüngsten Abbuchungsreihe (ein Preissprung eingeschlossen), und ein Empfänger, der in den drei jüngsten Monaten der Historie nicht mehr abgebucht hat, gilt als **beendet**. Ein beendetes Abo mindert den Safe-to-Spend nicht mehr und steht auf der Seite «Ausgaben» in einem eigenen Abschnitt «Beendet» — es verschwindet nicht, und es wird auch nicht zu «Kein Abo»: das bleibt die Aussage des Nutzers, dass etwas nie ein Abo war. Bucht der Empfänger wieder ab, erscheint das Abo beim nächsten Import automatisch wieder unter den laufenden, ohne neue «Neu»-Benachrichtigung.
>
