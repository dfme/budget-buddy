...
/**
 * Belegt das AC «Endpoints in Swagger UI sichtbar» von #254 (BE-REC-02).
 *
 * <p>Geprüft wird das generierte OpenAPI-Dokument unter {@code /v3/api-docs}, nicht die
 * Swagger-UI-Seite selbst — analog {@code NotificationOpenApiTest}.
 *
...
class RecurringExpenseOpenApiTest {

    @DynamicPropertySource
    static void datasourceProperties(DynamicPropertyRegistry registry) {
        PostgresTestDatabase.registerWithoutFlyway(registry, "recurring_expense_openapi");
    }
