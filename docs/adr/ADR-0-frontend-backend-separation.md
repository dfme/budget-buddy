...
- **Angular:** Requests mit `withCredentials: true`; Browser sendet Cookie automatisch — clientseitig kein Token-Interceptor nötig. Die Frontend-Interceptor führt ADR-2.
