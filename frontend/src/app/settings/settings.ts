 ...
 *
 * <p>Route, Navigation und drei Abschnitts-Cards — «Passwort» (FE-SET-02), «Erscheinungsbild»
 * (FE-SET-04) und «Konto löschen» (FE-SET-05, US-02) — sind alle gefüllt. Der frühere Abschnitt
 * «Einkommen» (FE-SET-03) ist seit FE-FC-09 Teil der Budget-Seite
 * (`onboarding/fixed-cost-list.ts`), nicht mehr hier.
 *
