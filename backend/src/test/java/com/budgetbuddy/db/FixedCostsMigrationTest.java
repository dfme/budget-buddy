...
/**
 * Verifiziert die Flyway-Migration V03 (fixed_costs-Tabelle) gegen eine echte PostgreSQL-Datenbank.
 *
...
class FixedCostsMigrationTest {
    ...
    private static final String TABLE = "fixed_costs";

    @DynamicPropertySource
    static void datasourceProperties(DynamicPropertyRegistry registry) {
        PostgresTestDatabase.register(registry, "fixed_costs_migration");
    }
    ...
    void fixedCostsTableHasAllColumnsWithCorrectTypes() {
        ...
        assertThat(typeByColumn.get("bezeichnung")).isEqualTo("text");
        assertThat(typeByColumn.get("intervall")).isEqualTo("text");
    }
    ...
    void allColumnsAreNotNull() {
        ...
        assertThat(notNullByColumn.get("bezeichnung")).isTrue();
        assertThat(notNullByColumn.get("betrag")).isTrue();
        assertThat(notNullByColumn.get("intervall")).isTrue();
    }
}
