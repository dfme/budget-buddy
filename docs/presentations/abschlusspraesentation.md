...
| B16 | 9–10 | Deployment in einem Satz: Single JAR auf Render (Frankfurt/EU), Neon Postgres getrennt, bewusst **kein** Redis/Queue/Microservices — Overengineering für 3 Devs / 3 Monate vermieden |
