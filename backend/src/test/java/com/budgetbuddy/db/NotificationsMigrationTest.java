...
/**
 * Verifiziert die Flyway-Migration V10 (notifications-Tabelle, DB-08) gegen eine echte
 * PostgreSQL-Datenbank.
 *
 * <p>V10 statt V08: Während dieser Branch offen war, wurde die Version zweimal von main
 * überholt — zuerst durch {@code V08__add_direction_uncertain_to_transactions.sql} (BE-PDF-10,
 * #193), dann durch {@code V09__add_token_version_to_users.sql}. Der Migrations-Guard
 * (INFRA-29) verhindert genau diese Kollision.
 *
...
class NotificationsMigrationTest {
    ...
    @Test
    void migrationsRunSuccessfullyThroughV10() {
        // V01 (users) ... V10 (notifications) müssen alle erfolgreich gelaufen sein.
