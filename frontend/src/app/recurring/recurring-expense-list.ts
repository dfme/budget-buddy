...
/**
 * Abschnitt «Erkannte Abos» auf `/fixkosten`: erkannte wiederkehrende Ausgaben mit «Neu»-Label
 ...
 * Abschnitt ganz. Der Klick führt seit FE-FC-05 nach `/fixkosten`, wo dieser Abschnitt steht.
 *
